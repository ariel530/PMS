...
(function ($) {
  ...
  setTimeout(function () {
      if (window.___browserSync___ === undefined && Number(localStorage.getItem('PMS:Demo:MessageShowed')) < Date.now()) {
      localStorage.setItem('PMS:Demo:MessageShowed', (Date.now()) + (15 * 60 * 1000))
  ...
  $container.append(
    '<h5>Customize PMS</h5><hr class="mb-2"/>'
  )
